namespace Emi.Portal.Movil.Logic.VideoCall
{
    ...
    public abstract class BaseOpenTokService : IOpenTokService
    {
        ...
        public abstract bool TryStartSession(bool sendBackToRoot);

        public abstract void EndSession(bool sendBackToRoot, bool showEvaluateCall);

        public abstract void CycleCamera();

        public abstract Task<bool> SendMessageAsync(string message, string type, bool to);
